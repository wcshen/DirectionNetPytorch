        ...
        for town, this_sequences in zip(towns, sequences):
            for sequence in this_sequences:
                ...
                for frame in range(total_frames):
                    ...
                    if not is_training:
                        yaw = 0
                    single_pcd_data = self.get_train_pcd(lidar_path, this_pose, self.num_points, self.box_2d, yaw)
...
if __name__ == '__main__':
    ...
    dataset.generate_single_sampling_data(is_training=True)
